...
- **Llama 3 8B 7/8 BYTE-IDENTICAL ✅ CONFIRMED 2026-05-21 at HEAD `80bd58fd`** — 7 of 8 quants (Q4_0/Q4_K_S/Q4_K_M/Q5_K_S/Q5_K_M/Q6_K/Q8_0) produce 0 bytes diff vs `/opt/hf2q/cache/byte_cmp/NousResearch-Meta-Llama-3-8B_canonical_*.gguf`. IQ4_NL has 587,776 bytes residual (known IQ4_NL kernel-floor issue per task #65 — `make_xs_dot_product` 4-bit lookup boundary). SHA256 Q4_K_M: `031317c1e1eb80b9c2a12def0ff6f251168dbfd2734fb3695187e208cc0066b3` matches canonical. Third arch fully closed (after Nomic v2-moe 8/8 + Gemma 4 8/8). **AC #2 matrix: 23/64 cells byte-identical**. Closure path: refactor llama3::build_metadata to gemma4 signature + emit_general_postlude (commit `25bf6034`) + Llama 3-specific tokenizer branch matching canonical `_set_vocab_gpt2` order (commit `80bd58fd`).
