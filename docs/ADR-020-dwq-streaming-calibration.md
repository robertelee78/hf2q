...
| **9** | 1 | Wire autograd into a synthetic 4-layer Qwen35 forward pass; per-Linear gradient capture; full `estimate_sensitivities` algorithm core matching `dynamic_quant.py:38-106`. | **NEXT** |
