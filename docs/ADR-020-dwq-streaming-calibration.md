...
| **11f** | 1 | Calibration data pipeline — tokenize sample text from `/opt/llama.cpp/tests` or HuggingFace WikiText fixture; produce `[batch, seq_len]` token ID buffers; embed via the iter-11d embedding op. | **NEXT** |
