...
| 11h-e | 1/2 | **MoE router** forward + backward on GpuTape — softmax over expert logits, top-K selection, expert weighting.  Standard math; deriving backward through top-K is the subtle piece. | |
