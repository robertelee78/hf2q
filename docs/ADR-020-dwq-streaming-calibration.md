...
| **11e** | 1 | Qwen3-0.6B-base weight loader integration — load GGUF dequant'd tensors into the GpuTape model's leaf tensors.  Reuses hf2q's existing GGUF loader; adds an `into_gpu_tape_leaves` adapter. | **NEXT** |
