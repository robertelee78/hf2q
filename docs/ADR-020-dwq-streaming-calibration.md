...
| 12f | 2 | Run §8.3 AC #6/#7/#8: convert Qwen3.6-27B + Gemma 4 26B → measure RSS < 100 GB + delta-PPL > 0.05 nats vs Q4_K_M baseline (WikiText-2). | |
