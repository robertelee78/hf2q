...
| **11d** | 1 | Multi-layer stack + embedding + lm_head + final RMSNorm.  Loop the iter-11c layer N times.  Embedding lookup is a tape op `OpKind::Embedding` (forward = gather; backward = scatter-add).  lm_head = matmul. | **NEXT** |
