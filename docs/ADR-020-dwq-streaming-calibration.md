...
| **8e** | 1 | GPU log_softmax + KL-div loss — composes from softmax + log + sub or new dedicated kernels; KL-div is the actual loss in mlx-lm `dynamic_quant.estimate_sensitivities`. | **NEXT** |
