...
| 11h-d | 1/2 | **`gated_delta_update` backward** — research-grade vjp.  No published reference; derive from the recurrence math (state update `S_t = α_t · S_{t-1} + β_t · k_t v_t^T`).  Multi-iter scope likely. | |
