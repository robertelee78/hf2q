...
- **Status**: 🚧 **IN PROGRESS** — Phases E1 + E3 + E4 + E5 + E6 (tree-mask v2) SHIPPED at hf2q `8cf9397b`. **187/187 eagle3 module tests PASS single-threaded** including max_depth=4 cross-branch GPU regression. E6 v1 rollback design had a CRITICAL bug (sibling expansion dropped ancestor K/V); E6 v2 fixes it with monotonic cache growth + per-call tree-aware attention mask. Remaining: codex /cfa Critical 0 final gate on E5+E6, HF2Q_SPEC_EAGLE3 env flag wiring, E2 drafter training (multi-week compute), E7 empirical validation, E8 final closure.
