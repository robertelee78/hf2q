...
| C — Gemma 4 26B DFlash (Option A xlen) | ✅ WIRED + byte-identical to base + 1.62× over Option C, 0.40× of base generation | OPT-IN only (HF2Q_SPEC_DFLASH=1 + HF2Q_DFLASH_XLEN_SDPA=1 + HF2Q_FULL_F16_KV=1; research-quality) |
