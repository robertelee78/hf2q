...
hosted tier. If no recommended-or-lower hosted artifact exists, it uses the
nearest higher tier that already passed automatic runtime resource admission
before attempting native source conversion.
