...
- **Status**: 🚧 IN PROGRESS — Steps 1 + 2 + 3 SHIPPED + Step 4 G4-CFA-1/2/3/4/5 (drafter-load layer A) SHIPPED at hf2q `eb7db222` (2026-05-23); CFA-5 Layer B + CFA-6 BLOCKED on CFA-5b (dense-Gemma-4 loader path)
- **Date**: 2026-05-22
