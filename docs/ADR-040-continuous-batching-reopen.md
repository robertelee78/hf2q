...
| `docs/ADR-040-continuous-batching-reopen.md` | ~190 | ~3 | this §6.1.45 closure + Status-line update + §6.1.32/§6.1.34/§6.1.38 followups marked SHIPPED for iter-2A-cont + iter-2-decode-B. |
...
- **iter-B4c-kernel-iter-2-decode-D** (UNCHANGED from §6.1.38): decode-side dense F32 + legacy 4-bit slot routing.
