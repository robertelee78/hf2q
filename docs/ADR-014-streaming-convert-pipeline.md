...
| P4 — Eliminate the P9b intermediate-GGUF dance | ⏳ pending | — | Depends on P0+P2. Closes ADR-012 P9b's `IntermediateMoeQ8Quantizer` workaround. |
| P5 — Sensitivity-JSON cache (DWQ across bit-pair variants) | ⏳ pending | — | Depends on P2. |
| P6 — Imatrix calibrator (pure-Rust port) | ⏳ pending | — | Depends on P0. Independent of P1–P5. |
| P7 — `Calibrator` × `OutputFormat` orthogonal split | ⏳ pending | — | Depends on P6. Refactor — no new behaviour. |
...
| P12 — Documentation refresh (`converting-a-model.md`, `converting-qwen35.md`, `shipping-contract.md`) | ⏳ pending | — | Depends on P11. |
