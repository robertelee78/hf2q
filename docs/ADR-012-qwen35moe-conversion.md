...
| P6 — DWQ hybrid-arch calibration (12, 13) | 🟡 pending | — | Hard blocker: no weight-space fallback wired; requires inference session's `ActivationCapture` impl (Decision 13). |
