...
| Commits on worktree `adr-012-p8-p11` | 32 commits ahead of `main` as of 2026-04-24 closure pass. Highlights: `ebec4a1` (P8 scaffold) · `0a1a7b7` (P11 + MTP stub fix + ADR-013 P14 cross-link) · `f33668f` (docs/arch-onboarding.md) · `13d619a` (P10 mmproj emitter + Layer C) · `6a3617c` (P10 Layer A + B) · `448477e` (P9 foundation) · `7d5d6eb` (P5 MoE wire-up fix) · `b136f1e` (RMS +1 wire-up — Q3 resolution) · `b08974e` (P3 V-head reorder wire-up — R2 closure) · `fd8133b` (deprecate emit_metadata validators) · `a1c0ce9` (Decision 15 non-qwen35 sidecar regression) · `e05c9cb` (Q1 + Q2 Open-Question resolutions documented) |
| Total tests | **2026-04-24 live count:** 950 unit (src/main.rs) + 110 integration across 18 binaries = 1060 passing · 1 known-flaky GPU float precision (ADR-013 `full_delta_net_layer_gpu_matches_cpu_ref`, max_abs_err 2.02e-3 vs 2e-3 — unrelated to ADR-012) · 11 ignored (7 unit + 4 integration, all real-model gates awaiting HF_TOKEN + disk). Per-integration-binary breakdown: smoke_conformance 15 · convert_qwen35_integration 6 · convert_qwen35moe_integration 6 · convert_qwen35_metadata_keys 4 · convert_qwen35_mtp_roundtrip 3 · convert_qwen35_real_activation_capture 2 · convert_qwen35_rms_norm_plus_one 3 · convert_vision_tower_integration 3 · convert_vision_tower_adr005_roundtrip 1 · quality_thresholds 4 · calibration_eval_disjoint 4 · upstream_citation_drift 6 · convert_integration 14 (incl. 2 non-qwen35 sidecar regressions) · cli_integration 18 · preflight_integration 12 · info_integration 4 · serve_ux 5 · create_fixture 0. |
