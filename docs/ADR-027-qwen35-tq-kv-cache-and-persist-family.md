...
- **Status:** Proposed (Phase A iter-1a..6b.3 LANDED 2026-05-08; Phase B iter-7..15 LANDED 2026-05-08, **production decode SDPA + KV write wired with HF2Q_TQ_KV branch**; needle-haystack + perf bench + ADR header flip remaining)
- **Date:** 2026-05-08
