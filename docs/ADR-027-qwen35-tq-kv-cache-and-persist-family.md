...
- **Status:** Phase A LANDED + Phase B LANDED (Phase A iter-1a..6b.3 + Phase B iter-7..16 all LANDED 2026-05-08); **🎯 LIVE COHERENCE PASS on qwen36 35B-A3B-APEX-Q5_K_M under HF2Q_TQ_KV=1 — TQ-on output BYTE-IDENTICAL to F32 baseline at 128.6 vs 128.0 tok/s** (operator-validated coherence smoke); needle-haystack + perf bench at 32K context = follow-up validation iters
- **Date:** 2026-05-08
