...
- `docs/adr/diary/ADR-028-peer-parity-coherence-and-speed.md` — the standing mission this ADR closes
- `docs/adr/diary/ADR-029-gemma4-moe-pipeline-is-the-gap.md` — the parallel-encode multi-month alternative this ADR avoids
