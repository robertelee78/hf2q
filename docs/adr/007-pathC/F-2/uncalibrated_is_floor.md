...
> write `docs/adr/007-pathC/F-2/uncalibrated_is_floor.md` with measured evidence
...
Full report: `docs/adr/007-pathC/F-0/empirical_kv_distribution.json`.
Raw data + analyzer: `docs/adr/007-pathC/F-0/iter-4.md` describes the capture
