...
use super::anchor_store::{
    effective_committed_depth, emit_anchor_restore_event, simultaneous_pending_capacity_slots,
    AnchorEntry, AnchorPublicationDisposition, AnchorRestoreEvent, AnchorStore, PruneResult,
    Publication, StagePending,
};
...
pub(super) fn record_restore(event: AnchorRestoreEvent) {
    TELEMETRY
