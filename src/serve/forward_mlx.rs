...
// ADR-038 Step 1 shared-primitives split — re-export to preserve external
// import paths (`crate::serve::forward_mlx::X`). Remove after ADR-038 Step 3
// retires forward_mlx.rs.
#[allow(unused_imports)]
pub use crate::serve::forward_mlx_shared::{
...
pub(crate) use crate::serve::forward_mlx_shared::{
    load_gguf_qweight, populate_f16_shadow_if_enabled, rms_norm_f32_hs_cached,
};

// ADR-038 Step 2 — Gemma KV-cache types moved to gemma4 module.
// Re-exported here to preserve `crate::serve::forward_mlx::X` import paths.
// Remove after ADR-038 Step 3 retires forward_mlx.rs.
pub use crate::inference::models::gemma4::kv_cache::{
    MlxKvCache, HbKvBuffers, DenseKvBuffers, HybridKvBuffers, DecodeRegime,
};
pub(crate) use crate::inference::models::gemma4::kv_cache::alloc_hybrid_kv_for_layer;
...
// cosine_pairwise_f32 and cosine_tests moved to forward_mlx_shared.rs
// (ADR-038 Step 1). Re-exported via the pub use shim above.
...
// dispatch_qmatmul_f32_router_test and ac5_iter_b_affine_qweight_roundtrip
// moved to forward_mlx_shared.rs (ADR-038 Step 1).


// load_gguf_qweight, populate_f16_shadow_if_enabled, RmsNormPerHeadArgs,
// dispatch_rms_norm_unit_perhead, dispatch_rms_norm_unit_perhead_dual_perm,
// rms_norm_f32_hs_cached, dispatch_qmatmul moved to forward_mlx_shared.rs
// (ADR-038 Step 1). Re-exported via the pub use shim above.
