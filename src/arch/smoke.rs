...
impl SmokeEnv for RealSmokeEnv {
    fn hf_token(&self) -> Option<String> {
        // Smoke and conversion must make the same authentication decision.
        // The input module owns the single precedence chain and its pure,
        // deterministic tests.
        crate::input::hf_download::resolve_auth_token()
    }
