...
//!
//! Phase tracker (status at HEAD `3ea809f` for mlx-native kernel and
//! `11cabdcc` for hf2q ADR):
//!
...
//!   hidden state plumbing. **E3a SHIPPED**: `multi_layer_hidden.rs`
//!   defines `Eagle3HiddenCollector` and the
