//! Q5_1 quantizer — ADR-033 P0 pure-Rust port of the peer's
//! `quantize_row_q5_1_ref`, `quantize_row_q5_1_impl`, and
//! `quantize_q5_1`.
//!
...
pub fn quantize(src: &[f32], n_per_row: usize, imatrix: Option<&[f32]>) -> Vec<u8> {
    ...
    // ADR-036 Layer A: per-row parallelism (each block in ref/impl is
    // independent — same justification as Q5_K).
