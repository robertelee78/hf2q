//! Q4_1 quantizer — ADR-033 P0 pure-Rust port of the peer's
//! `quantize_row_q4_1_ref` and
//! `quantize_row_q4_1_impl`, with the dispatcher
//! `quantize_q4_1` selecting between them on
//! `quant_weights != NULL`.
//!
