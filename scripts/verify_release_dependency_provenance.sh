...
readonly EXPECTED_DEPENDENCY_VERSION=0.15.0
readonly EXPECTED_DEPENDENCY_REQUIREMENT='=0.15.0'
readonly EXPECTED_DEPENDENCY_SOURCE='registry+https://github.com/rust-lang/crates.io-index'
readonly EXPECTED_DEPENDENCY_CHECKSUM=09d3decffbf66811bac728abd51697c89cd699e031bc1b4295470108f235b822
