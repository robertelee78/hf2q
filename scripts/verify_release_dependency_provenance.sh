...
readonly EXPECTED_DEPENDENCY_VERSION=0.12.1
readonly EXPECTED_DEPENDENCY_REQUIREMENT='=0.12.1'
readonly EXPECTED_DEPENDENCY_SOURCE='registry+https://github.com/rust-lang/crates.io-index'
readonly EXPECTED_DEPENDENCY_CHECKSUM=1ac31334d9d6c74286451a0860b029b527a45d9264098301f98cd866f9e1147e
