...
echo "  Post 10-iter doc-scrub + pkill defense (HEAD eeaa51be / 3074807b / a2478294 2026-05-22, focused 3-rep):"
...
echo "    MH long-context hypothesis FALSIFIED at HEAD c5c51701 (3-rep + warmup + PINNED fixture tests/fixtures/long_prompt/natural_2k_verifier_rs_head400.txt): Base 17.40, greedy 14.85 (0.85×), MH 0.5 14.07 (0.81× WORST), MH 0.7 14.43 (0.83×). All MTP configs REGRESS vs base at ~2K natural. Prior 2-rep result suggesting MH 0.7 marginally helps was 40% variance artifact."
echo "    K=0 spec FALSIFIED at HEAD 531784f6 (3-rep): Base 14.43, K=0 spec 12.63 @ 88.9% accept = 0.88× REGRESSES. K=0 has HIGHER accept (89% vs K=1 78%) but MTP draft overhead ~10ms/iter dominates. ALL 3 long-context quick-win hypotheses now FALSIFIED (MH, verifier kernel cost, K=0). Remaining fixes are multi-week: drafter training, tree decoding, DFlash with custom drafter."
echo
