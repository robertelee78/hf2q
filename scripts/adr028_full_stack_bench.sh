...
run_stack "Path E+F+G (F16 KV ~25 ppm)" "HF2Q_USE_DENSE=1 HF2Q_F16_KV=1 HF2Q_LMHEAD_Q6K=1 HF2Q_UNSAFE_EXPERIMENTS=1"
run_stack "Path E+F+G + FUSED_END_OF_LAYER" "HF2Q_USE_DENSE=1 HF2Q_F16_KV=1 HF2Q_LMHEAD_Q6K=1 HF2Q_FUSED_END_OF_LAYER=1 HF2Q_UNSAFE_EXPERIMENTS=1"
...
echo
echo "Reference (iter-216 measurements):"
echo "  Default:       68.8 tok/s   (0.670x peer)"
echo "  Path E:        ~71  tok/s   (~0.69x peer)"
echo "  Path E+G:      72.4 tok/s   (0.705x peer)"
echo "  Path E+F+G:    73.3 tok/s   (0.713x peer)"
echo "  Path +FUSED:   73.6 tok/s   (0.717x peer)"
