...
fail() {
    echo "optional integration guide contract failed: $*" >&2
    exit 1
}
...
require_literal "$readme" "A [separate optional integration guide]"
...
echo "optional OpenCode/AK/search integration guide contract passed"
